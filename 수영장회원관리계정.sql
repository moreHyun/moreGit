...
ALTER TABLE S_CLASS_TEACHER
  ADD CONSTRAINT PK_CLASS_TEACHER PRIMARY KEY (CLASS_NO, TEACHER_ID);
ALTER TABLE S_CLASS_TEACHER
  ADD CONSTRAINT FK_CLASS_TEACHER_01 FOREIGN KEY (CLASS_NO)
  REFERENCES S_CLASS (CLASS_NO);
ALTER TABLE S_CLASS_TEACHER
  ADD CONSTRAINT FK_CLASS_TEACHER_02 FOREIGN KEY (TEACHER_ID)
  REFERENCES S_TEACHER (TEACHER_ID);
...
INSERT INTO S_GRADE (MEMBER_NO, LEVEL)
VALUES('S001', '중');
INSERT INTO S_GRADE (MEMBER_NO, LEVEL)
VALUES('S002', '중');
INSERT INTO S_GRADE (MEMBER_NO, LEVEL)
